        ...
        return (
            <div className="GreetingContainer">
                <div className="about">
                    ...
                    <div className="title">
                        <div className="block">
                            <p className="title_1 animate__animated animate__fadeInLeft">Наша компания продает
                        ...
                        <div className="block">
                            ...
                            <p className="title_2 animate__animated animate__fadeInRight">Вы можете заказать компютер на
                        ...
                        <div className="block">
                            ...
                            <p className="title_3 animate__animated animate__fadeInLeft">Большой выбор компьютеров,
                                такие как
